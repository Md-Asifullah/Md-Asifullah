...
- **[on-this-day](https://github.com/Md-Asifullah/on-this-day)** – A simple React app that displays historical events that occurred on this day in past years.  
- **[task-tally](https://github.com/Md-Asifullah/task-tally)** – A task management web application for freelancers, built with Vue.  
- **[light-tasks](https://github.com/Md-Asifullah/light-tasks)** – A lightweight project management application built with React.  
- **[medical-home-page](https://github.com/Md-Asifullah/medical-home-page)** – A practice project designing the homepage UI of a medical website using React.
